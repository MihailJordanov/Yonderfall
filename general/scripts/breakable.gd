...
@export var hit_audio : AudioStream = preload("uid://bkhuhg7v1gfq0")
@export var destroy_audio : AudioStream = preload("uid://cdapc6k6wj5at")
...
func _ready() -> void:
	...
	hp = float(SaveManager.persistent_data.get_or_add(unique_name(), hp))
